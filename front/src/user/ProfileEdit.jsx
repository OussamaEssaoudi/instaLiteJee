      ...
      <div className="py-32">
          <div className="overflow-hidden bg-white border shadow-lg sm:rounded-lg mx-8">
              <div className="px-4 py-5 sm:px-6 shadow sm:overflow-hidden sm:rounded-md">
                  <h3 className="text-lg font-medium leading-6 text-gray-900">Edit your Information</h3>
            ...
            <form action="#" method="POST">
              <div className="overflow-hidden shadow sm:rounded-md">
                ...
                <button
                    ...
                    className="bg-gray-400 mr-5  border rounded-xl py-2 px-4 justify-center items-center text-sm hover:scale-105 duration-300 text-white"
                    >
                    Cancel
                  </button>
